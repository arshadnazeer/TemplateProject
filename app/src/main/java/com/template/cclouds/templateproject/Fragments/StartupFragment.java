package com.template.cclouds.templateproject.Fragments;
...
public class StartupFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               mNavigateToFragmentListener.goToLoginFragment();
            }
        });
        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mNavigateToFragmentListener.goToSignUpFragment();
            }
        });
    ...
    NavigateToFragmentListener mNavigateToFragmentListener;

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        this.mNavigateToFragmentListener = (NavigateToFragmentListener) context;

    }

    private static StartupFragment instance;
    public static Fragment getInstance() {
        if( instance == null ) {
            instance = new StartupFragment();
        }
        return instance;
    }

    public interface NavigateToFragmentListener {
        void goToStartUpFragment();
